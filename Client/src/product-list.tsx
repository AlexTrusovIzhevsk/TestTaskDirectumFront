...
@autobind
class ProductList extends React.Component<{ isBasket: boolean; currentCategory: string | null}, { products: Array<IProductInfo> }> {
  constructor(props: { isBasket: boolean; currentCategory: string }) {
    super(props);
    this.state = { products: [] };
